...
def get_args():
    ...
    parser.add_argument('--input_data_path', type=str, default='../data/vessel_all.hdf5')
    ...
    parser.add_argument('--start_ckpts_encoder', type=str,
                        default='../generate/logs/vessel_all/2024-05-11-21-03-52/encoder_99.pth')
    parser.add_argument('--log_dir', type=str, default='./logs')

    # Model
    parser.add_argument('--part_num', default=6, type=int)
